...
const {createpatient, addmember, viewfamily, viewdocss, charge, remove, medichistory, viewhealthpack, subscribeToPackage, ViewHealthPackages, cancelSub, addtimes, viewslots, select, viewSubscriptionStatus, showWallet, filterMyAppointments, viewPrescriptions, rescheduleApp, cancelApp, requestfollowup}= require('./routes/patient')
const { createdoctor, updatedoc, viewpatients, viewpatient, addHealthRecord, viewAvailableAppointments, viewAppointments, showDoctorWallet, filterDoctorAppointments, addapt, addtimeslot, addPrescription, viewDoctorPrescriptions, cancelPatientApp, acceptpatient, acceptFollowUpAppointment, revokeFollowUpAppointment } = require('./routes/doctors')
